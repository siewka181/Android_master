...
export const translations = {
  PL: {
    ...
    developerDiagnosticsTitle: "Developer Diagnostics",
    devDiagnosticsStarted: "Uruchamianie Developer Diagnostics",
    devDiagnosticsFinished: "Developer Diagnostics zakończone.",
    devDiagnosticsFailed: "Developer Diagnostics nie powiodło się",
    devDiagnosticsErrorTitle: "Błąd diagnostyki",
    devDiagnosticsShareDialogTitle: "Udostępnij raport diagnostyczny",
    devDiagnosticsRunning: "Trwa uruchamianie diagnostyki...",
    devDiagnosticsRunFull: "Uruchom pełny self-test",
    devDiagnosticsFailingChecks: "Niezaliczone testy",
    devDiagnosticsReadiness: "Gotowość",
    devDiagnosticsRecentErrors: "Ostatnie znormalizowane błędy",
    devDiagnosticsCopySummary: "Kopiuj/udostępnij summary",
    devDiagnosticsExportTxt: "Eksport TXT",
    devDiagnosticsExportJson: "Eksport JSON",
    devDiagnosticsExportFailed: "Nie udało się wyeksportować raportu diagnostycznego.",
    devDiagnosticsSummaryCopied: "Skopiowano debug summary do schowka.",
    devDiagnosticsSummaryShared: "Udostępniono debug summary jako plik.",
    devDiagnosticsClipboardFailed: "Nie udało się skopiować/udostępnić debug summary.",
  },
  ...
  EN: {
    ...
    developerDiagnosticsTitle: "Developer Diagnostics",
    devDiagnosticsStarted: "Developer Diagnostics started",
    devDiagnosticsFinished: "Developer Diagnostics finished.",
    devDiagnosticsFailed: "Developer Diagnostics failed",
    devDiagnosticsErrorTitle: "Diagnostics error",
    devDiagnosticsShareDialogTitle: "Share diagnostics report",
    devDiagnosticsRunning: "Running diagnostics...",
    devDiagnosticsRunFull: "Run full self-test",
    devDiagnosticsFailingChecks: "Failing checks",
    devDiagnosticsReadiness: "Readiness",
    devDiagnosticsRecentErrors: "Recent normalized errors",
    devDiagnosticsCopySummary: "Copy/share summary",
    devDiagnosticsExportTxt: "Export TXT",
    devDiagnosticsExportJson: "Export JSON",
    devDiagnosticsExportFailed: "Failed to export diagnostics report.",
    devDiagnosticsSummaryCopied: "Debug summary copied to clipboard.",
    devDiagnosticsSummaryShared: "Debug summary shared as file.",
    devDiagnosticsClipboardFailed: "Failed to copy/share debug summary.",
  },
};
